...
需求描述“为什么做、边界是什么”；产品实际怎样运行、失败怎样恢复以及怎样验收，分别以 [全项目 SOP 总览](SOP_INDEX.md)、[全项目正向 SOP](USER_SOP.md)、[全项目逆向与恢复 SOP](FAILURE_RECOVERY_SOP.md)和[验收测试矩阵](ACCEPTANCE_TEST_MATRIX.md)为准。
